        ...
        <table style="width: 100%; height: 540px;">
            <tr>
                ...
                <td style="height: 77px; width: 480px">
                    <asp:Image ID="Image3" runat="server" ImageUrl="~/images/pjct/banner-admin.jpg" 
                        Width="475px" />
                </td>
            ...
            <tr>
                <td style="height: 321px; width: 222px;">
                    ...
                    <asp:Image ID="Image1" runat="server" Height="193px" 
                        ImageUrl="~/images/pjct/pelatihan.png" Width="192px" />
                </td>
                <td style="width: 480px; height: 321px">
                    <asp:Panel ID="Panel2" runat="server" 
                        BackImageUrl="~/images/pjct/Video Background Texture.jpg" BorderStyle="Groove" 
                ...
                <td style="height: 321px">
                    ...
                    <asp:Image ID="Image2" runat="server" Height="203px" 
                        ImageUrl="~/images/pjct/admlog.png" Width="189px" />
                </td>
            </tr>
            <tr>

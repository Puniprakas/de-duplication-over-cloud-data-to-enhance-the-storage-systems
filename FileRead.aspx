<%@ Page Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="FileRead.aspx.cs" Inherits="FileRead" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel ID="Panel1" runat="server" Height="834px" style="" 
        ...
        <table style="width: 100%; height: 824px">
            <tr>
                <td style="height: 74px; width: 184px">
                    ...
                    <table style="width: 143%">
                        ...
                        <tr>
                            ...
                            <td style="width: 261px">
                                ...
                                Text="File Read &amp; Download!"></asp:Label>
                            </td>
                            <td>
                                &nbsp;</td>
                        </tr>
            ...
            <tr>
                <td style="height: 605px; width: 184px">
                </td>
                <td style="width: 399px; height: 605px">
                    <asp:Panel ID="Panel2" runat="server" BackImageUrl="~/images/pjct/download/3c42571b1949c7e961a9981caa1ea09a.gif" 
                    BorderStyle="Groove" Height="598px" Width="564px">
                            ...
                            <tr>
                                ...
                                <td style="width: 220px; ">
                                    <asp:Button ID="Button1" runat="server" BackColor="#006600" 
                                        ...
                                        ForeColor="Yellow" Height="32px" onclick="Button1_Click" Text="Download" 
                                        Width="89px" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" BackColor="Red" 
                                        BorderColor="Yellow" BorderStyle="Ridge" BorderWidth="1px" 
                                        CausesValidation="False" Font-Bold="True" ForeColor="Yellow" Height="32px" 
                                        onclick="Button2_Click" Text="Cancel" Width="74px" />
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                ...
                <td style="height: 605px">
                    <asp:Label ID="Label36" runat="server" Font-Size="Small" ForeColor="#FF9900" 
                        Font-Bold="True" Visible="False">Read Request :</asp:Label>
                    <br />
                    <br />
                    <asp:Label ID="Label37" runat="server" Font-Bold="True" Font-Size="Small" 
                        ForeColor="#FF9900" Visible="False"></asp:Label>
                </td>
            </tr>
            <tr>

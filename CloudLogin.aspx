<%@ Page Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="CloudLogin.aspx.cs" Inherits="CloudLogin" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel ID="Panel1" runat="server" Height="522px" style="" 
        ...
        <table style="width: 100%; height: 540px;">
            <tr>
                <td style="height: 77px; width: 232px;">
                    &nbsp;</td>
            ...
            <tr>
                <td style="height: 321px; width: 232px;">
                    &nbsp;&nbsp;&nbsp;
                    <asp:Image ID="Image1" runat="server" Height="193px" 
                        ImageUrl="~/images/pjct/Database-Cloud-icon.png" Width="192px" />
                </td>
                <td style="width: 480px; height: 321px">
                    <asp:Panel ID="Panel2" runat="server" 
                        BackImageUrl="~/images/pjct/103848807.jpg" BorderStyle="Groove" 
                ...
                <td style="height: 321px">
                    ...
                    <asp:Image ID="Image2" runat="server" Height="203px" 
                        ImageUrl="~/images/pjct/hosted.png" Width="189px" />
                </td>
            </tr>
            <tr>
                <td style="width: 232px; height: 231px;">
                </td>
